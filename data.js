...
// const filterData = (valueName = null, valueSchool = null) => {
//   let d = data
//     // .filter((elem) => elem.name.toLowerCase().includes(valueName.toLowerCase()))
//     .filter(
//       (elem) => valueSchool !== null ? elem.house.includes(valueSchool) : elem 
//     );
//   return d;
// };

// console.log(filterData("ha", 'Ravenclaw'));
